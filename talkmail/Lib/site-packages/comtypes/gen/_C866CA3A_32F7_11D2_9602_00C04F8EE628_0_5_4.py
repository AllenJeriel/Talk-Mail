...
__all__ = [
    'ISpStreamFormat', 'SBONone', 'ISpeechObjectTokens',
    'ISpObjectTokenCategory', 'SpeechLexiconType',
    'DISPID_SRRecognizer', 'SVSFPurgeBeforeSpeak', 'STCAll',
    'DISPID_SVVoice', 'DISPID_SDKDeleteValue', 'SPRS_ACTIVE',
    'SAFT12kHz8BitStereo', 'SPCT_DICTATION', 'eLEXTYPE_PRIVATE13',
    'SVSFUnusedFlags', 'DISPID_SpeechLexicon', 'DISPID_SRCVoice',
    'ISpeechXMLRecoResult', 'SpeechRecognitionType', 'ISpEventSource',
    'SPEI_ADAPTATION', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRGetPropertyString', 'eWORDTYPE_ADDED',
    'SPEI_TTS_PRIVATE', 'DISPID_SVSInputSentencePosition',
    'DISPID_SAFGetWaveFormatEx', 'SpeechCategoryAudioOut',
    'DISPID_SRGId', 'ISpStreamFormatConverter', 'SpObjectToken',
    'DISPID_SRCRetainedAudio', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SVPause', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRGCmdLoadFromFile', 'SVEPrivate',
    'DISPID_SpeechLexiconPronunciation', 'SPPHRASERULE',
    'SPTEXTSELECTIONINFO', 'SPEI_UNDEFINED', 'DISPID_SPRuleParent',
    ...
    'DISPID_SRGetRecognizers', 'DISPID_SpeechPhraseRules',
    'SAFTNoAssignedFormat', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRIsShared', 'SPDATAKEYLOCATION', 'SP_VISEME_17',
    'DISPID_SPPNumberOfElements', 'ISpeechMemoryStream',
    'SpeechUserTraining', 'SPEI_MIN_TTS', 'DISPID_SRGRules',
    'SAFTExtendedAudioFormat', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SPRuleFirstElement', 'SWPKnownWordPronounceable',
    'DISPID_SRGetPropertyNumber', 'DISPID_SpeechPhoneConverter',
    'DISPID_SGRSTNextState', 'DISPID_SLGetWords',
    'Speech_Max_Pron_Length', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechAudio', 'eLEXTYPE_RESERVED10',
    'SPEI_SR_AUDIO_LEVEL', 'SAFT24kHz8BitMono', 'SREBookmark',
    'SpeechGrammarTagDictation', 'DISPID_SVSkip', 'SFTSREngine',
    'DISPID_SGRAddResource', 'SPEI_TTS_BOOKMARK', 'SPSFunction',
    'SECFIgnoreKanaType', 'DISPID_SRSCurrentStreamNumber',
    'SREStreamStart', 'DISPID_SRProfile', 'DISPID_SPEAudioSizeTime',
    'SVP_21', 'SPSHORTCUTTYPE', 'DISPID_SRGCmdLoadFromMemory',
    'SAFTADPCM_8kHzMono', 'eLEXTYPE_PRIVATE17', 'DISPID_SRCESoundEnd',
    'DISPID_SVDisplayUI', 'SP_VISEME_13', 'SSTTWildcard',
    'SPLO_DYNAMIC', 'DISPID_SPRuleName', 'DISPID_SpeechVoiceStatus',
    'DISPID_SPRulesCount', 'SREAllEvents',
    'DISPID_SRRSetTextFeedback', 'ISpeechPhraseInfoBuilder',
    'SpTextSelectionInformation', 'SPINTERFERENCE_TOOLOUD',
    'SpNullPhoneConverter', 'SP_VISEME_18', 'ISpeechObjectToken',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPRsItem', 'SP_VISEME_8',
    'SPINTERFERENCE_NOISE', 'ISpeechResourceLoader', 'SPEI_RESERVED6',
    'SPXMLRESULTOPTIONS', 'SAFT22kHz16BitMono', 'DISPID_SPIStartTime',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRRPhraseInfo',
    'DISPID_SVEventInterests', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRCEPropertyNumberChange', 'SVP_13', 'ISpeechAudioStatus',
    'SPBO_TIME_UNITS', 'SPLO_STATIC', 'DISPID_SPRFirstElement',
    'eLEXTYPE_PRIVATE5', 'SVP_4', 'SPXRO_SML', 'ISpPhrase',
    'SVESentenceBoundary', 'DISPID_SGRsFindRule',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SASNonBlockingIO',
    'DISPID_SPPEngineConfidence', 'SGDSActiveUserDelimited',
    'DISPID_SRCEAudioLevel', 'SREFalseRecognition',
    'ISpeechPhraseReplacements', 'SPINTERFERENCE_TOOFAST',
    '__MIDL_IWinTypes_0009', 'ISequentialStream',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SOTRemove',
    'SRATopLevel', 'DISPID_SPIEnginePrivateData',
    'DISPID_SVEStreamStart', 'SPEI_START_INPUT_STREAM',
    'DISPID_SASState', 'SPRECOSTATE', 'SRERecoOtherContext',
    'SVSFNLPSpeakPunc', 'DISPID_SOTsItem', 'ISpAudio', 'SINoise',
    'DISPID_SPEsCount', 'SpeechEngineConfidence', 'SpMMAudioOut',
    'DISPID_SpeechGrammarRule', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPIReplacements', 'SINone', 'tagSPPROPERTYINFO',
    'DISPID_SDKSetStringValue', 'DISPID_SGRsAdd',
    'ISpeechLexiconPronunciation', 'SpeechMicTraining',
    'DISPID_SLPPartOfSpeech', 'SAFT8kHz8BitMono', 'SPRULE',
    'DISPID_SpeechObjectToken', 'DISPID_SPRules_NewEnum',
    'DISPID_SGRSTs_NewEnum', 'STCInprocHandler', 'SPEI_VISEME',
    'DISPID_SGRInitialState', 'SPWT_LEXICAL', 'SpInprocRecognizer',
    'SPAS_RUN', 'SPEI_SR_PRIVATE', 'SAFT22kHz8BitStereo',
    'DISPID_SPPValue', 'SSFMOpenReadWrite', 'DISPID_SVAlertBoundary',
    'DISPID_SGRSTsCount', 'eLEXTYPE_APP', 'SSFMOpenForRead',
    'DISPID_SPILanguageId', 'SPEI_RESERVED3', 'SRSEIsSpeaking',
    'DISPID_SGRSTransitions', 'SITooFast', 'SP_VISEME_9',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SMSGetData',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPWT_PRONUNCIATION',
    'DISPID_SGRSAddWordTransition', 'DISPID_SAEventHandle',
    'DISPID_SRCResume', 'SPPS_LMA', 'SVSFPersistXML',
    'ISpeechRecognizer', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SDKSetLongValue', 'DISPID_SLWsItem', 'SPPS_Function',
    'DISPID_SPERetainedSizeBytes', 'SPCS_DISABLED',
    'DISPID_SRCRequestedUIType', 'SVP_10', 'DISPID_SOTSetId',
    'SPSNotOverriden', 'SpeechVisemeFeature', 'SPSMF_UPS',
    'SPGS_ENABLED', 'IInternetSecurityMgrSite', 'DISPID_SOTId',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SOTRemoveStorageFileName',
    'SpeechPropertyAdaptationOn', 'DISPID_SMSALineId',
    'DISPID_SpeechXMLRecoResult', 'SRCS_Enabled',
    ...
    'STSF_AppData', 'SLTUser', 'SDTPronunciation', 'SPPROPERTYINFO',
    'SVP_0', 'ISpeechPhraseRule', 'SPBINARYGRAMMAR',
    'SpeechAudioVolume', 'ISpeechGrammarRuleStateTransitions',
    'SRAImport', 'DISPID_SRRSpeakAudio', 'SP_VISEME_11',
    'SPSHT_EMAIL', 'DISPID_SpeechRecognizerStatus',
    'SPEI_SOUND_START', 'DISPID_SVStatus', 'DISPID_SVVolume',
    'DISPID_SRGDictationUnload', 'SPAR_High',
    'DISPID_SDKGetBinaryValue', 'DISPIDSPTSI_SelectionLength',
    'SVP_17', 'ISpeechCustomStream', 'SVSFVoiceMask',
    'SDKLLocalMachine', 'SITooSlow',
    'DISPID_SRCAudioInInterferenceStatus', 'SWTAdded', 'SWTDeleted',
    'ISpVoice', 'DISPID_SPEAudioTimeOffset',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFT8kHz16BitStereo',
    'DISPID_SpeechPhraseElement', 'SPPHRASEPROPERTY',
    'DISPID_SDKEnumValues', 'SpMMAudioIn', 'DISPID_SLPsCount',
    'eLEXTYPE_RESERVED7', 'DISPID_SLPPhoneIds', 'DISPID_SPAs_NewEnum',
    'SPSSuppressWord', 'SRADynamic', 'SpeechAudioFormatGUIDWave',
    'SAFTCCITT_uLaw_22kHzStereo',
    'SpeechPropertyHighConfidenceThreshold',
    'SpeechGrammarRuleStateTransitionType', 'SP_VISEME_5',
    'SPFM_OPEN_READWRITE', 'DISPID_SGRsCommit', 'SPEI_END_SR_STREAM',
    'ISpeechPhraseAlternate', 'DISPID_SGRAttributes', 'SPRULESTATE',
    'DISPID_SRStatus', 'SINoSignal', 'DISPID_SRIsUISupported',
    'eLEXTYPE_USER', 'DISPID_SGRSTWeight', 'SPBO_PAUSE',
    'ISpeechLexiconPronunciations', 'SGDisplay', 'STSF_LocalAppData',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SOTsCount',
    'eLEXTYPE_PRIVATE3', 'SRTExtendableParse',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SRCState',
    'SpeechVoicePriority', 'SITooQuiet', 'SSFMCreateForWrite',
    'ISpNotifyTranslator', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVEViseme', 'SAFTGSM610_8kHzMono', 'SpeechGrammarState',
    'DISPID_SGRSTRule', 'DISPID_SPRulesItem', 'DISPID_SRSClsidEngine',
    'SpeechBookmarkOptions', 'DISPID_SRCERecognition', 'SP_VISEME_19',
    'SRARoot', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRGDictationSetState', 'SECFDefault', 'DISPID_SVRate',
    'SpeechStreamFileMode', 'ISpRecognizer3', 'ISpeechPhraseProperty',
    'SpeechTokenKeyUI', 'DISPID_SPIGetText',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPIRule',
    'SAFT44kHz8BitMono', 'Speech_StreamPos_RealTime', 'SPWORDLIST',
    ...
    'SAFTADPCM_22kHzMono', 'SGRSTTWildcard', 'STCInprocServer',
    'SVP_6', 'DISPID_SDKGetStringValue', 'SPRST_ACTIVE', 'SRSEDone',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechAudioFormatGUIDText', 'SPFM_NUM_MODES', 'DISPID_SVResume',
    'SpeechPropertyResourceUsage', 'SPEI_RESERVED2',
    'eLEXTYPE_PRIVATE7', 'SP_VISEME_15', 'DISPID_SDKSetBinaryValue',
    'DISPID_SAFGuid', 'ISpeechPhraseRules', 'ISpSerializeState',
    ...
    'SECFNoSpecialChars', 'DISPID_SDKEnumKeys', 'SPVPRI_OVER',
    'DISPID_SGRSTPropertyId', 'SRSActive', 'SPPS_RESERVED4',
    'DISPID_SVEEnginePrivate', 'DISPID_SVGetProfiles', 'SPWORDTYPE',
    'SVP_11', 'DISPID_SWFESamplesPerSec', 'SPDKL_LocalMachine',
    ...
    'DISPID_SGRSTsItem', 'SAFTADPCM_11kHzMono', 'SPEI_INTERFERENCE',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SSSPTRelativeToStart',
    'SECFIgnoreCase', 'DISPID_SLGetGenerationChange', 'SRTAutopause',
    'DISPID_SOTCGetDataKey', 'DISPID_SRCPause',
    'SpeechRegistryLocalMachineRoot', 'SpAudioFormat',
    'SPPS_Interjection', 'DISPID_SPIElements', 'eLEXTYPE_PRIVATE19',
    'SRAORetainAudio', 'eLEXTYPE_RESERVED9', 'DISPID_SLPType',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SGRName', 'SPSUnknown',
    'DISPID_SPPsCount', 'SGRSTTDictation', 'SPPARTOFSPEECH',
    'DISPID_SRRTimes', 'DISPID_SRSNumberOfActiveRules', 'SVP_2',
    'SRTReSent', 'DISPID_SABIMinNotification', 'DISPID_SRGCommit',
    'eLEXTYPE_MORPHOLOGY', 'SREHypothesis',
    'SpeechPropertyLowConfidenceThreshold', 'SVEAudioLevel',
    'SPPS_Noun', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SVEStreamEnd', 'SRAInterpreter', 'SpeechRuleAttributes',
    'SGPronounciation', 'DISPID_SGRSAddRuleTransition',
    'ISpeechPhraseAlternates', 'STSF_CommonAppData', 'SpWaveFormatEx',
    'DISPID_SRCCmdMaxAlternates', 'SAFT11kHz16BitMono',
    'SpSharedRecognizer', 'ISpeechPhraseProperties',
    'DISPID_SOTCategory', 'DISPID_SLRemovePronunciation',
    'SRESoundStart', 'DISPID_SGRAddState', 'DISPID_SpeechVoice',
    'SPSLMA', 'DISPID_SRCBookmark', 'DISPID_SGRSRule',
    'SPDKL_CurrentUser', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SPAsCount', 'SPEI_RESERVED1', 'SVSFIsNotXML',
    'SpMemoryStream', 'SpSharedRecoContext', 'DISPID_SOTCId',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPRsCount',
    'DISPID_SGRSAddSpecialTransition', 'SVP_14', 'SPFM_OPEN_READONLY',
    'SpPhoneConverter', 'DISPIDSPRG', 'DISPID_SpeechDataKey',
    'SDKLDefaultLocation', 'SAFT11kHz8BitMono', 'SPPS_Noncontent',
    'DISPID_SRDisplayUI', 'DISPID_SRRAudioFormat',
    'DISPID_SVSLastBookmarkId', 'DISPID_SREmulateRecognition',
    'SP_VISEME_7', 'DISPID_SpeechPhraseInfo', 'SPCS_ENABLED',
    'SDTLexicalForm', 'DISPID_SPEsItem', 'SRAExport',
    'SPEI_PHRASE_START', 'SPWT_DISPLAY', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SREPhraseStart', 'SPPS_NotOverriden', 'SPPS_RESERVED2',
    'SECFIgnoreWidth', 'DISPID_SPRDisplayAttributes',
    'ISpRecoCategory', 'ISpeechRecoContext', 'DISPID_SPPConfidence',
    'SpeechGrammarTagUnlimitedDictation', 'SAFTCCITT_ALaw_22kHzMono',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechEmulationCompareFlags',
    'DISPID_SLPsItem', 'SRERecognition',
    'DISPID_SVSLastStreamNumberQueued', 'SP_VISEME_4', 'SPVPRIORITY',
    'SPRST_INACTIVE', 'DISPID_SLWPronunciations',
    'DISPID_SRSAudioStatus', 'DISPID_SVSVisemeId',
    'SPCT_SUB_DICTATION', 'SVP_18', 'DISPID_SOTDisplayUI',
    'DISPID_SVEAudioLevel', 'DISPID_SRCEventInterests',
    'DISPID_SPPChildren', 'SP_VISEME_1',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRRAudio',
    'DISPID_SPPParent', 'SAFTADPCM_22kHzStereo',
    'DISPID_SpeechMemoryStream', 'DISPID_SPAPhraseInfo',
    'ISpeechGrammarRule', 'SVSFParseSsml', 'DISPID_SLPSymbolic',
    'SPAS_PAUSE', 'DISPID_SRRTStreamTime', 'DISPID_SVEWord',
    'DISPID_SLGenerationId', 'SPSTREAMFORMATTYPE',
    'DISPID_SVGetAudioInputs', 'SpeechAudioState',
    'DISPID_SRAudioInput', 'SPEI_MAX_SR', 'DISPID_SRRSaveToMemory',
    'SpeechCategoryVoices', 'eLEXTYPE_PRIVATE14', 'SpeechRuleState',
    'DISPID_SFSClose', 'DISPID_SGRs_NewEnum',
    'DISPID_SPEDisplayAttributes', 'IInternetSecurityManager',
    'DISPID_SVWaitUntilDone', 'DISPID_SVSRunningState',
    'Speech_StreamPos_Asap', 'ISpXMLRecoResult', 'eLEXTYPE_PRIVATE11',
    'SVP_5', 'DISPID_SBSRead', 'SpObjectTokenCategory',
    'SGDSActiveWithAutoPause', 'SREStateChange', 'SRCS_Disabled',
    'SP_VISEME_16', 'DISPID_SRCRecognizer', 'ISpEventSink',
    'SPBOOKMARKOPTIONS', 'SPCT_COMMAND', 'DISPID_SVEBookmark',
    'SAFT44kHz16BitMono', 'SFTInput', '_ISpeechVoiceEvents',
    'ISpeechRecoGrammar', 'SAFTADPCM_11kHzStereo', 'SVEViseme',
    'eLEXTYPE_RESERVED8', 'DISPID_SpeechGrammarRules', 'ISpeechAudio',
    'SECFEmulateResult', 'SAFT22kHz8BitMono', 'SVEStartInputStream',
    'SSFMCreate', 'DISPID_SRGState', 'DISPID_SRRAlternates',
    'DISPID_SPPName', 'SLODynamic', 'SPDKL_DefaultLocation',
    'SPGRAMMARWORDTYPE', 'DISPID_SGRId', 'DISPID_SRCreateRecoContext',
    'DISPID_SRGDictationLoad', 'SAFT32kHz8BitMono',
    'SpNotifyTranslator', 'SpeechRecoContextState',
    'DISPID_SOTCEnumerateTokens', '_SPAUDIOSTATE',
    'DISPID_SRCEEndStream', 'DISPID_SDKCreateKey',
    'SAFT32kHz8BitStereo', 'DISPID_SLWs_NewEnum',
    'IEnumSpObjectTokens', 'DISPID_SVSInputSentenceLength', 'SPEVENT',
    'ISpMMSysAudio', 'SpeechPropertyResponseSpeed', 'SPAUDIOSTATE',
    'SASClosed', 'SAFTCCITT_ALaw_11kHzMono', 'SpStream',
    'DISPID_SOTIsUISupported', 'SGRSTTWord', 'DISPID_SVAudioOutput',
    'SVP_9', 'DISPID_SLWWord', 'SpUnCompressedLexicon',
    'SSSPTRelativeToCurrentPosition', 'SPRECORESULTTIMES',
    'SPEI_RECOGNITION', 'SPPS_Verb', 'ISpResourceManager',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SPRuleConfidence', 'SASStop',
    'SRTSMLTimeout', 'SpFileStream', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPRuleChildren', 'SVEPhoneme', 'SVSFParseSapi',
    'DISPID_SRGSetWordSequenceData', 'SREStreamEnd',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRSetPropertyString', 'ISpeechObjectTokenCategory',
    'SDTAudio', 'DISPID_SRCEStartStream', 'SPRST_ACTIVE_ALWAYS',
    'SRTStandard', 'SpeechRetainedAudioOptions', 'SPWORD',
    'SPWF_INPUT', 'DISPID_SPANumberOfElementsInResult',
    'SpeechAddRemoveWord', 'SP_VISEME_14', 'SGSExclusive',
    'DISPID_SDKGetlongValue', 'SPEI_SR_RETAINEDAUDIO', 'SREPrivate',
    'DISPID_SASFreeBufferSpace', 'DISPID_SDKDeleteKey',
    'SPSInterjection', 'SAFT8kHz8BitStereo', 'SAFTADPCM_44kHzStereo',
    'SpeechAllElements', 'SAFT16kHz8BitStereo', 'eLEXTYPE_PRIVATE12',
    'SAFTGSM610_22kHzMono', 'DISPID_SLGetPronunciations',
    'DISPID_SPEActualConfidence', 'SREInterference', 'SDTAlternates',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SpeechPhraseRule',
    'DISPID_SWFEBitsPerSample', 'SRESoundEnd', 'SPRECOGNIZERSTATUS',
    'DISPID_SLWsCount', 'eLEXTYPE_PRIVATE18', 'SVP_19',
    'SPPS_Unknown', 'IStream', 'ISpeechMMSysAudio',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRCERecognitionForOtherContext', 'SPFILEMODE',
    'ISpeechAudioBufferInfo', 'DISPID_SGRSTText', 'SVPOver',
    'DISPID_SpeechCustomStream', 'SPEI_START_SR_STREAM',
    'DISPID_SVSLastResult', 'SPSHORTCUTPAIRLIST', 'SPSNoun',
    ...
    'SAFT11kHz16BitStereo', 'DISPID_SVPriority', 'LONG_PTR',
    'SPVOICESTATUS', 'SPRECOCONTEXTSTATUS', 'SSTTTextBuffer',
    'SVSFParseAutodetect', 'DISPID_SVESentenceBoundary',
    'DISPID_SRRRecoContext', 'SpeechDataKeyLocation',
    'SAFTCCITT_ALaw_22kHzStereo', 'tagSPTEXTSELECTIONINFO',
    'SWPUnknownWordPronounceable', 'DISPID_SpeechObjectTokens',
    'eLEXTYPE_PRIVATE1', 'DISPID_SpeechAudioFormat',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpeechAudioProperties',
    'STCRemoteServer', 'DISPID_SABIBufferSize', 'DISPID_SMSSetData',
    'DISPID_SVSInputWordPosition', 'SAFT16kHz16BitMono',
    'DISPID_SVSPhonemeId', 'eLEXTYPE_RESERVED4',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_END_INPUT_STREAM',
    'eLEXTYPE_USER_SHORTCUT', 'SAFTGSM610_44kHzMono',
    'ISpeechGrammarRules', 'UINT_PTR', 'SGSEnabled', 'SPBO_AHEAD',
    'ISpeechRecoResultTimes', 'SVP_8', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPIProperties', 'DISPID_SOTCreateInstance',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPGRAMMARSTATE', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SPERequiredConfidence', 'SVF_Stressed',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFT16kHz8BitMono',
    'SPSModifier', 'SPEI_SOUND_END', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SLTApp', 'SPEI_WORD_BOUNDARY', 'SpeechDisplayAttributes',
    'SPCT_SLEEP', 'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SAStatus',
    'SPFM_CREATE', 'SP_VISEME_2', 'DISPID_SPCPhoneToId', 'SPVISEMES',
    'SRSInactive', 'DISPID_SpeechPhraseElements',
    'DISPID_SpeechPhraseReplacements', 'SVP_7', 'SPAUDIOBUFFERINFO',
    'SpInProcRecoContext', 'SPCONTEXTSTATE', 'DISPID_SPIEngineId',
    'SpeechTokenKeyFiles', 'DISPID_SRGReset', 'SECLowConfidence',
    'SREPropertyNumChange', 'SpeechRegistryUserRoot',
    'SAFT44kHz16BitStereo', 'ISpeechGrammarRuleStateTransition',
    'SVPNormal', 'DISPID_SpeechBaseStream', 'ISpShortcut',
    'DISPIDSPTSI', 'SREPropertyStringChange', 'SPGS_DISABLED',
    'SpeechCategoryPhoneConverters', 'DISPID_SRAudioInputStream',
    'SDTReplacement', 'DISPID_SVGetVoices', 'SECNormalConfidence',
    'eLEXTYPE_LETTERTOSOUND', 'WAVEFORMATEX', 'SDTProperty',
    'SPRST_NUM_STATES', 'SVEVoiceChange', 'DISPID_SRRTTickCount',
    ...
    'ISpeechAudioFormat', 'SVEEndInputStream', 'SP_VISEME_0',
    'ISpeechFileStream', 'DISPID_SGRsCount', 'SPEI_MIN_SR',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPAS_CLOSED',
    'SPXRO_Alternates_SML', 'SGSDisabled', 'SPAO_NONE',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SVSpeakStream',
    'DISPID_SpeechRecoContext', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SPIGetDisplayAttributes',
    'SAFTCCITT_uLaw_22kHzMono', 'SAFT48kHz8BitStereo',
    'SPEI_SENTENCE_BOUNDARY', 'SGDSActive',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPLOADOPTIONS',
    'SpeechCategoryAppLexicons', 'DISPID_SASetState', 'SLOStatic',
    'DISPID_SpeechRecognizer', 'SPEI_HYPOTHESIS',
    'DISPID_SPARecoResult', 'DISPID_SPPsItem', 'ISpGrammarBuilder',
    'ISpRecognizer2', 'SpeechRecoProfileProperties',
    'DISPID_SRRGetXMLResult', 'DISPID_SOTMatchesAttributes',
    'ISpRecoResult', 'SDA_Consume_Leading_Spaces', 'SPPHRASE',
    '_ISpeechRecoContextEvents', 'ISpeechLexiconWords', 'ISpStream',
    'SDTAll', 'SPBO_NONE', 'eLEXTYPE_PRIVATE10', 'STSF_FlagCreate',
    'DISPID_SPEPronunciation', 'SVSFNLPMask',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPRs_NewEnum',
    'DISPID_SRCEPropertyStringChange', 'SASPause',
    'DISPID_SpeechRecoResult', 'IEnumString', 'eLEXTYPE_PRIVATE16',
    'ISpeechPhraseElement', 'DISPID_SOTCDefault', 'SPSEMANTICFORMAT',
    'DISPID_SGRSTType', 'DISPID_SGRSTPropertyName',
    'DISPID_SPELexicalForm', 'ISpeechVoiceStatus',
    'SAFTGSM610_11kHzMono', 'SVSFParseMask', 'SPEI_VOICE_CHANGE',
    'DISPID_SPPFirstElement', 'SpeechTokenShellFolder',
    'SpeechVoiceSkipTypeSentence', 'ISpPhraseAlt',
    'DISPID_SWFEFormatTag', 'DISPID_SWFEExtraData', 'SVP_16',
    'SAFTNonStandardFormat', 'SPPS_RESERVED3', 'SAFT24kHz16BitStereo',
    'eLEXTYPE_PRIVATE2', 'SSSPTRelativeToEnd', 'DISPID_SBSFormat',
    'SVP_12', 'SpeechWordType', 'DISPID_SOTGetDescription',
    'DISPID_SGRClear', 'SVPAlert', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SLAddPronunciation', 'SpeechRunState',
    'SECHighConfidence', 'DISPID_SLPs_NewEnum',
    'DISPID_SpeechLexiconWord',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SAFT44kHz8BitStereo',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SWFEChannels',
    'DISPID_SADefaultFormat', 'DISPID_SRGSetTextSelection',
    'SAFT12kHz8BitMono', 'DISPID_SPISaveToMemory',
    'eLEXTYPE_PRIVATE6', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRSetPropertyNumber', 'DISPID_SpeechLexiconWords',
    'SpeechRecognizerState', 'SPWF_SRENGINE', 'ISpeechRecoResult',
    'SVEBookmark', 'DISPID_SRGIsPronounceable', 'SVSFDefault',
    'SPVPRI_NORMAL', 'SAFTCCITT_uLaw_8kHzMono',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SPPBRestorePhraseFromMemory',
    'SAFT24kHz8BitStereo', 'SDA_No_Trailing_Space', 'DISPID_SPRText',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPEEngineConfidence',
    'DISPID_SpeechAudioStatus', 'eLEXTYPE_PRIVATE8',
    'DISPID_SpeechFileStream', 'ISpeechPhraseInfo',
    'DISPID_SGRSTPropertyValue', 'SVSFIsFilename',
    'DISPID_SPEDisplayText', 'SGLexicalNoSpecialChars',
    'Speech_Default_Weight', 'SVP_20', 'SPSHORTCUTPAIR',
    'SAFT16kHz16BitStereo', 'SRSActiveAlways',
    'DISPID_SGRsCommitAndSave', 'SPSERIALIZEDPHRASE', 'SPSHT_Unknown',
    'SVEAllEvents', 'DISPID_SASCurrentDevicePosition', 'SAFTText',
    'DISPID_SPPs_NewEnum', 'SVF_None', 'SPCT_SUB_COMMAND',
    'DISPID_SPIAudioStreamPosition', 'SPEI_REQUEST_UI',
    'SDKLCurrentConfig', 'SPEI_RECO_OTHER_CONTEXT',
    'SpeechInterference', 'SPWORDPRONUNCIATION', 'DISPID_SRState',
    'DISPID_SAVolume', 'SPLEXICONTYPE', 'SDA_One_Trailing_Space',
    'DISPID_SOTGetAttribute', 'SDTRule', 'DISPID_SMSAMMHandle',
    'SP_VISEME_10', 'SGRSTTRule', 'SPAR_Medium', 'SPPS_Modifier',
    'DISPID_SRGRecoContext', 'DISPID_SRRDiscardResultInfo',
    'SDA_Two_Trailing_Spaces', 'SPINTERFERENCE_NONE',
    'SPEI_RESERVED5', 'SAFTDefault', 'STCLocalServer',
    'DISPID_SBSSeek', 'SDTDisplayText', 'SVP_1',
    'DISPID_SPIAudioSizeBytes', 'SBOPause', 'DISPID_SVEPhoneme',
    'ISpeechWaveFormatEx', 'SVP_3', 'SPPHRASEREPLACEMENT',
    'SPVPRI_ALERT', 'DISPID_SPRuleId', 'eLEXTYPE_PRIVATE15',
    'ISpeechPhoneConverter', 'DISPID_SRRTLength',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SMSADeviceId', 'ISpObjectToken',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SLWType', 'SVSFIsXML',
    'SGDSInactive', 'SpeechCategoryAudioIn',
    'DISPID_SpeechVoiceEvent', 'SVP_15', 'SAFTCCITT_ALaw_44kHzStereo',
    'ISpRecognizer', 'SpeechRecoEvents', 'DISPID_SpeechRecoResult2',
    'SSTTDictation', 'SVEWordBoundary', 'SP_VISEME_12',
    'SPWAVEFORMATTYPE', 'SPSHT_NotOverriden', 'DISPID_SPEs_NewEnum',
    'ISpeechRecognizerStatus', 'SPAUDIOSTATUS',
    'DISPID_SABIEventBias', 'DISPID_SPACommit', 'SREAudioLevel',
    'SAFT48kHz16BitMono', 'SPAS_STOP', 'ISpRecoGrammar',
    'DISPID_SOTGetStorageFileName', 'SDKLCurrentUser', 'SPSVerb',
    'DISPID_SPIGrammarId', 'ISpDataKey',
    'SpeechSpecialTransitionType', 'DISPID_SpeechPhraseAlternate',
    'SPAR_Unknown', 'SAFT8kHz16BitMono', 'SASRun',
    'SPDKL_CurrentConfig', 'ISpeechVoice', 'SP_VISEME_20',
    'SAFT22kHz16BitStereo', 'SPAR_Low',
    'DISPID_SpeechPhraseReplacement', 'SPCATEGORYTYPE',
    'SPPS_SuppressWord', 'DISPID_SpeechPhraseProperty', 'SITooLoud',
    'SVSFlagsAsync', 'SPSEMANTICERRORINFO',
    'DISPID_SRCEFalseRecognition', 'ISpPhoneConverter',
    'DISPID_SpeechAudioBufferInfo', 'ISpNotifySink',
    'SpStreamFormatConverter', 'ISpObjectWithToken', 'ISpProperties',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPAsItem',
    'DISPID_SABufferNotifySize', 'eWORDTYPE_DELETED',
    'DISPID_SPEAudioSizeBytes', 'ISpeechLexiconWord',
    '_RemotableHandle', 'SPAO_RETAIN_AUDIO',
    'SpeechTokenKeyAttributes', 'SPSHT_OTHER',
    'SPADAPTATIONRELEVANCE', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SGRSTTTextBuffer', 'SPEI_FALSE_RECOGNITION', 'SGRSTTEpsilon',
    'SpeechPartOfSpeech', 'DISPID_SRCEPhraseStart',
    'SpeechVisemeType', 'DISPID_SRGCmdSetRuleState',
    'SPPHRASEELEMENT', 'SpVoice', 'SPFM_CREATE_ALWAYS',
    'DISPIDSPTSI_SelectionOffset', 'SpeechCategoryRecognizers',
    'DISPID_SDKOpenKey', 'SpeechVoiceEvents', 'tagSTATSTG',
    'SAFT24kHz16BitMono', 'DISPID_SPPId', 'DISPID_SRCESoundStart',
    'DISPIDSPTSI_ActiveLength', 'ISpeechBaseStream',
    'DISPID_SRRTOffsetFromStart', 'Speech_Max_Word_Length',
    'DISPID_SpeechMMSysAudio',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SOTDataKey',
    'eLEXTYPE_VENDORLEXICON', 'SP_VISEME_3', 'SAFT32kHz16BitStereo',
    'SPEVENTENUM', 'DISPID_SAFType', 'DISPID_SCSBaseStream',
    ...
    'eLEXTYPE_PRIVATE4', 'eLEXTYPE_PRIVATE20',
    'DISPID_SpeechLexiconProns', 'SP_VISEME_21',
    'DISPID_SPAStartElementInResult', 'SPEVENTSOURCEINFO',
    'DISPID_SABufferInfo', 'SAFT32kHz16BitMono', 'ISpLexicon',
    'ISpRecoContext2', 'eLEXTYPE_RESERVED6',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRSSupportedLanguages',
    'SPEI_PHONEME', 'SpPhoneticAlphabetConverter', 'SPAUDIOOPTIONS',
    'DISPID_SBSWrite', 'DISPID_SOTs_NewEnum', 'SPEI_SR_BOOKMARK',
    'DISPID_SOTCSetId', 'SpMMAudioEnum', 'DISPID_SLWLangId',
    'SAFTADPCM_44kHzMono', 'DISPID_SVSpeak', 'SpeechAudioFormatType',
    'SRAONone', 'ISpeechDataKey', 'SPINTERFERENCE', 'DISPID_SFSOpen',
    'SPPS_RESERVED1', 'DISPID_SRCEAdaptation',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SRTEmulated',
    'DISPID_SPRuleNumberOfElements', 'SREAdaptation', 'SPEI_MAX_TTS',
    'DISPID_SRCCreateGrammar', 'SpeechGrammarWordType',
    'SPGS_EXCLUSIVE', 'SAFT48kHz8BitMono', 'SpShortcut',
    'SpPhraseInfoBuilder', 'DISPID_SPCIdToPhone',
    'DISPID_SVSInputWordLength', 'SPSERIALIZEDRESULT', 'SGLexical',
    'ISpeechRecoResultDispatch', 'ISpeechRecoResult2',
    'DISPID_SGRsItem', 'SPINTERFERENCE_TOOQUIET', 'SPRS_INACTIVE',
    'SPWORDPRONOUNCEABLE', 'SAFTADPCM_8kHzStereo',
    ...
    'ISpeechGrammarRuleState', 'SP_VISEME_6', 'DISPID_SRCERequestUI',
    'DISPID_SWFEBlockAlign', 'ISpRecoContext', 'ISpeechLexicon',
    'SpeechStreamSeekPositionType', 'ISpNotifySource'
]

_check_version('1.2.0', 1697025151.146991)
